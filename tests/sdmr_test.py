...
class SDMRTestCase(unittest.TestCase):
    def setUp(self):
        np.random.seed(0)
    ...
    def _init_sdmr(self):
        ...
        lda = dmr.SDMR(K, SIGMA, BETA, docs, vecs, voca.size())
        return voca, docs, vecs, lda

    def test_sdmr___init__(self):
        '''
        SDMR.__init__
        '''
        voca, docs, vecs, lda = self._init_sdmr()
